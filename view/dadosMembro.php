        ...
        <form class="form-horizontal" action="../Controller/membroController.php" method="POST">
            ...
            <div class="box-body">
                <div class="form-group ">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="cpf" placeholder="CPF" disabled
                               data-inputmask='"mask": "999.999.999-99"' data-mask value="<?= $dado['cpf'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nome" name="nome" disabled
                               placeholder="Nome Completo" value="<?= $dado['nome'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="usuario" name="usuario" disabled
                               placeholder="Usuario para acessar o sistema" value="<?= $dado['usuario'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="rg" class="col-sm-2 control-label">RG</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="rg" name="rg" placeholder="RG" disabled
                               value="<?= $dado['rg'] ?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="celular" name="celular" placeholder="Celular"
                               disabled data-inputmask='"mask": "(99) 99999-9999"' data-mask
                               value="<?= $dado['celular'] ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="Telefone Fixo" name="telefone" disabled
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="Endereço" name="endereco" disabled
                               value="<?= $dado['endereco'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="Tipo" name="tipo" disabled
                               value="<?= $dado['tipo'] ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="box-footer">
                <a href="listarMembros.php" type="button" class="btn btn-default">Voltar</a>
            </div>
            <!-- /.box-footer -->
        </form>
    </div>
